...
**Data source:** `source="ssh_logs_new.json" host="vanshika_4245" sourcetype="_json"`
...
```spl
source="ssh_logs_new.json" host="vanshika_4245" sourcetype="_json" event_type="Successful SSH Login"
...
```spl
source="ssh_logs_new.json" host="vanshika_4245" sourcetype="_json" auth_attempts>3 auth_success=false
| stats count by id.orig_h
| sort -count
```
